describe('funcionalidades de cadastro', () => {
  ...
  it('cadastrar um novo usuário', () => { 
    ...
    cy.get('[data-qa="signup-name"]').type('Maxwell Hora');
    cy.get('[data-qa="signup-email"]').type('Maxwell@gmail.com');
    cy.get('[data-qa="signup-button"]').click();
    cy.get(':nth-child(1) > b').should('be.visible');

    cy.get('#id_gender1').click();
    cy.get('[data-qa="name"]').clear().type('Maxwell Hora');
    cy.get('[data-qa="email"]').should('have.value', 'Maxwell@gmail.com');
    ...
    cy.get('[data-qa="first_name"]').type('Maxwell');
    ...
    cy.get('b').should('have.text', 'Maxwell')
